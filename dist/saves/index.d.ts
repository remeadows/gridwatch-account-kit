export type { SaveGameConfig, SavesClient, LoadResult, StoreResult, ReconcileResult, ReconcileOptions, CloudSave, SaveError } from "./types.js";
export { CONFLICT_COPY, OWNERSHIP_COPY, REPLACE_COPY, createDomPromptHost, type PromptHost, type PromptCopy, type PromptAnswer } from "./prompt.js";
